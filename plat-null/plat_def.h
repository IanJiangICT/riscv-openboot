...
#define SOC_CORE_MARCHID_PC 0x00000000
#define SOC_CORE_MARCHID_MC 0x00000003
...
#define PLAT_ROM_MC		(PLAT_ROM_BASE + SOC_ROM_SEGMENT_SIZE * 0)
#define PLAT_ROM_BC0	(PLAT_ROM_BASE + SOC_ROM_SEGMENT_SIZE * 1)
#define PLAT_ROM_ST		(PLAT_ROM_BASE + SOC_ROM_SEGMENT_SIZE * 2)
#define PLAT_ROM_PC		(PLAT_ROM_BASE + SOC_ROM_SEGMENT_SIZE * 3)
